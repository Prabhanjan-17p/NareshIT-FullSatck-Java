...
public class BootProj17MiniProjectWithProfiles_Fallback_Include {

	public static void main(String[] args) {
		try (ConfigurableApplicationContext run = SpringApplication
				.run(BootProj17MiniProjectWithProfiles_Fallback_Include.class, args); Scanner sc = new Scanner(System.in)) {
